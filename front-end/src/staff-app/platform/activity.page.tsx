...
export const ActivityPage: React.FC = () => {
  const [getActivities, fetchedActivities, loadState] = useApi<{ activity: Activity[] }>({ url: "get-activities" })

  const [data, setData] = useState<Activity[]>([])
  const [showDetails, setShowDetails] = useState<boolean>(false)
  const [index, setIndex] = useState<number>()

  if (fetchedActivities && fetchedActivities.activity.length && !data.length) {
              ...
              return (
                <S.Card key={i}>
                  ...
                  {showDetails &&
                    index === i &&
                    d.entity &&
                    d.entity.student_roll_states.map((en, ind) => {
                      return (
                        <S.CardDetailsContainer key={ind}>
                          <S.CardItem>
